...
const file_api_tasks_services_proto_rawDesc = "" +
	...
	"\x12GetAllDependencies\x124.api.v1.task_tracker.tasks.GetAllDependenciesRequest\x1a5.api.v1.task_tracker.tasks.GetAllDependenciesResponse\"'\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/api/v1/get_all_dependenciesBLZJgithub.com/bogi-lyceya-44/task-tracker/pkg/pb/api/tasks;task_tracker_tasksb\x06proto3"
